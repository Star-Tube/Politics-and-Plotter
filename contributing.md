...
## Report bugs using Github's [issues](https://github.com/Star-Tube/Stat-Plotter/issues)
...
Follow [PEP8](https://www.python.org/dev/peps/pep-0008/). Feel free to PR fixes to any style errors I make.
